...
public class AsyncPostAccount extends AsyncTask<Void, Void, String> {
    ...
    public AsyncPostAccount(AppCompatActivity appCompatActivity, String account_name, String value, String id_ac_category, String nama_category,String tanggal_input) {
